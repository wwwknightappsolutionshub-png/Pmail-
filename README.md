...
Standalone project for **HostNet** (custom VPS hosting panel) and **hmail** (fully branded webmail UI).
...
|---------|--------|-------------|
| **hmail** | Phase 1 | Branded webmail UI powered by Hostinger IMAP/SMTP |
| **HostNet** | Phase 2 (planned) | Custom WHM-style hosting panel on Ubuntu VPS |
...
- Web: http://localhost:5173/login/demo
