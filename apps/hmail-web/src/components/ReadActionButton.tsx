...
import "./ReadActionButton.css";

const TOOLTIP_Z = 10040;
  ...
  return (
    <>
      <button
        ref={buttonRef}
        type="button"
        className={`read-action-btn${variant === "danger" ? " read-action-btn--danger" : ""}`}
        onClick={onClick}
        disabled={disabled}
        aria-label={label}
