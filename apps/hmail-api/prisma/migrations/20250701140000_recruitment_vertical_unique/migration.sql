...
ALTER TABLE "RcContact" ADD COLUMN "availabilityDate" TIMESTAMP(3);
ALTER TABLE "RcContact" ADD COLUMN "candidateStage" TEXT NOT NULL DEFAULT 'sourced';
ALTER TABLE "RcContact" ADD COLUMN "lastContactedAt" TIMESTAMP(3);
...
ALTER TABLE "RcRole" ADD COLUMN "targetStartDate" TIMESTAMP(3);
...
ALTER TABLE "RcPlacement" ADD COLUMN "startDate" TIMESTAMP(3);
ALTER TABLE "RcPlacement" ADD COLUMN "offerAcceptedAt" TIMESTAMP(3);
ALTER TABLE "RcPlacement" ADD COLUMN "recruiterFeeCents" INTEGER;
ALTER TABLE "RcPlacement" ADD COLUMN "guaranteeEndDate" TIMESTAMP(3);
...
CREATE TABLE "RcCandidateSubmission" (
    ...
    CONSTRAINT "RcCandidateSubmission_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "RcOutreachCampaign" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "RcOutreachCampaign_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "RcReferenceCheck" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "RcReferenceCheck_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "RcCandidateSubmission" ADD CONSTRAINT "RcCandidateSubmission_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcCandidateSubmission" ADD CONSTRAINT "RcCandidateSubmission_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "RcRole"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcCandidateSubmission" ADD CONSTRAINT "RcCandidateSubmission_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "RcContact"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcOutreachCampaign" ADD CONSTRAINT "RcOutreachCampaign_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcOutreachCampaign" ADD CONSTRAINT "RcOutreachCampaign_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "RcRole"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "RcOutreachCampaign" ADD CONSTRAINT "RcOutreachCampaign_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcReferenceCheck" ADD CONSTRAINT "RcReferenceCheck_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcReferenceCheck" ADD CONSTRAINT "RcReferenceCheck_contactId_fkey" FOREIGN KEY ("contactId") REFERENCES "RcContact"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "RcReferenceCheck" ADD CONSTRAINT "RcReferenceCheck_placementId_fkey" FOREIGN KEY ("placementId") REFERENCES "RcPlacement"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "RcReferenceCheck" ADD CONSTRAINT "RcReferenceCheck_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
