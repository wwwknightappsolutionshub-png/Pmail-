-- Phase D: Growth qualification chatbot (SQLite)
...
CREATE TABLE "GrowthChatbotConfig" (
    ...
    CONSTRAINT "GrowthChatbotConfig_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "GrowthWorkspace" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "GrowthChatSession" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "GrowthChatSession_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "GrowthWorkspace" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "GrowthChatMessage" (
    ...
    "stepKey" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "GrowthChatMessage_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "GrowthChatSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
