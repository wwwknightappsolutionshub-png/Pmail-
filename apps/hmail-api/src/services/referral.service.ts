...
<div class="wrap" style="max-width:620px;margin:0 auto;padding:24px 16px"><div class="card" style="background:#fff;border-radius:18px;border:1px solid #99f6e4;overflow:hidden">
<div class="brand-top" style="display:flex;justify-content:space-between;align-items:center;padding:16px 24px;background:linear-gradient(135deg,#042f3f,#0d9488);color:#fff"><strong class="brand-logo" style="font-size:1.35rem">PMail+</strong><span class="brand-tag" style="font-size:.78rem;opacity:.88;text-transform:uppercase;letter-spacing:.12em">MAIL WORKSPACE</span></div>
<div class="head" style="padding:24px 24px 8px;color:#0f172a"><h1 style="margin:0 0 8px;font-size:1.5rem;font-weight:700;line-height:1.25;color:#0f172a">Explore More Possibilities With Mails On PMail+ | Join Me</h1><p style="margin:0;color:#475569;font-size:.96rem;line-height:1.55">A smarter mail workspace with tools that grow with your business</p></div>
<div class="body" style="padding:8px 24px 24px;line-height:1.65;font-size:15px;color:#334155">
<p>Hi there,</p>
<p>I've switched my day-to-day mail to <strong>PMail+</strong> and thought you'd benefit from it too. It's more than inbox — it's a workspace where mail, scheduling, and business tools stay in one place.</p>
...
<p><a class="btn" href="${safeUrl}" style="display:inline-block;margin-top:18px;padding:12px 24px;background:#0d9488;color:#fff;text-decoration:none;border-radius:999px;font-weight:600">Explore PMail+</a></p>
